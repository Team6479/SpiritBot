 ...
 */
public class CustomDrive implements MotorSafety {
   ...
   */
  public CustomDrive(final int leftMotorChannel, final int rightMotorChannel) {
   ...
   */
  public CustomDrive(final int frontLeftMotor, final int rearLeftMotor, final int frontRightMotor,
   ...
   */
  public CustomDrive(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
  ...
  public void drive(double outputMagnitude, double curve) {
    ...
    setLeftRightMotorOutputs(-1*leftOutput, rightOutput);
  }
