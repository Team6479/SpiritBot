...
public class LedLighting extends Subsystem {
  ...
  /**
   * This is a lightly modified version of the enum from commit e541d4e81c8204ff47805c00a963d08427906132.
   * That is legacy code that I largely don't understand, and it seems to be written jankily.
   * Many of the features were removed and this was designed to contain everything necessary within a subsystem,
   * rather than a seperate class. This shouldn't negatively impact the funtionality we use.
   */
  public enum Mode {
